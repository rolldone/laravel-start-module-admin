        ...
        <div class="row g-2 align-items-center">
          ...
          <div class="col-12 col-md-auto ms-auto d-print-none">
            <div class="btn-list">
              ...
              <a class="btn btn-primary d-none d-sm-inline-block" href="/admin/group-management/divisi/new">
                        ...
                        <div class="btn-list flex-nowrap">
                          ...
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                              <a class="dropdown-item" :href="'/admin/group-management/divisi/'+item.id+'/view'">Edit</a>
