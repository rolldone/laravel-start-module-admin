...
export default {
  ...
  methods: {
    ...
    handleClick(action: string, props: any, e: any) {
      switch (action) {
        case 'GENERATE_AUTH_AND_SUBMIT':
          e.preventDefault();
          this.$props.onlistener({
            with_auth: true
          }, e);
          break;
        case 'IGNORE_AND_SUBMIT':
          e.preventDefault();
          this.$props.onlistener({
            with_auth: false
          }, e);
    ...
    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body text-center py-4">
          ...
          <div class="text-muted">Before continue process, do you want register this user to have own authentication?
          </div>
          <br>
        ...
        <div class="modal-footer">
          <div class="w-100">
            <div class="row">
              <div class="col">
                <a v-on:click="handleClick('GENERATE_AUTH_AND_SUBMIT',{},$event)" class="btn btn-primary w-100"
                  data-bs-dismiss="modal">
                  Yes Generate for him first.
                </a>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col">
                <a v-on:click="handleClick('IGNORE_AND_SUBMIT',{},$event)" class="btn w-100" data-bs-dismiss="modal">
                  Ignore it and keep continue.
                </a>
              </div>
            </div>
          </div>
